...
/* harmony import */ var src_app_servicios_armar_horario_data_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/servicios/armar-horario/data.service */ "./src/app/servicios/armar-horario/data.service.ts");




let InicioPage = class InicioPage {
    constructor(modalController, data, navCtrl, platform) {
    ...
    init() {
        ...
        if (datos) {
            ...
            this.data = new src_app_servicios_armar_horario_data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"]();
